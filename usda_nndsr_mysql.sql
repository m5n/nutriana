...
create table FOOD_DES (
    ...
    N_Factor dec(4, 2) unsigned,   -- Factor for converting nitrogen to protein (see p. 10).
    Pro_Factor dec(4, 2) unsigned,   -- Factor for calculating calories from protein (see p. 11).
    Fat_Factor dec(4, 2) unsigned,   -- Factor for calculating calories from fat (see p. 11).
    CHO_Factor dec(4, 2) unsigned   -- Factor for calculating calories from carbohydrate (see p. 11).
);
...
create table NUT_DATA (
    ...
    Deriv_Cd varchar(4),   -- Data Derivation Code giving specific information on how the value is determined
    Ref_NDB_No varchar(5),   -- NDB number of the item used to impute a missing value. Populated only for items added or updated starting with SR14.
    Add_Nutr_Mark varchar(1),   -- Indicates a vitamin or mineral added for fortification or enrichment. This field is populated for ready-to-eat breakfast cereals in food group 8.
...
create table WEIGHT (
    ...
    Msre_Desc varchar(80) not null,   -- Description (for example, cup, diced, and 1-inch pieces).
...
create table NUTR_DEF (
    ...
    Tagname varchar(20),   -- International Network of Food Data Systems (INFOODS) Tagnames. (INFOODS, 2009.) A unique abbreviation for a nutrient/food component developed by INFOODS to aid in the interchange of data.
...
create table DERIV_CD (
    ...
    Deriv_Desc varchar(263) not null   -- Description of derivation code giving specific information on how the value was determined.
);
...
create table DATA_SRC (
    ...
    Title varchar(255),   -- Title of article or name of document, such as a report from a company or trade association.
