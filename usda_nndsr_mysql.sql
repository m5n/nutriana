...
insert into DERIV_CD (Deriv_Desc, Deriv_Cd) values ('Added by http://github.com/m5n/nutriana to avoid foreign key error', '');
insert into FOOD_DES (Shrt_Desc, NDB_No, FdGrp_Cd, Long_Desc) values ('See Long_Desc', '', '0100', 'Added by http://github.com/m5n/nutriana to avoid foreign key error');
insert into NUTR_DEF (NutrDesc, Sr_Order, Units, Nutr_No, Num_Dec) values ('Added by http://github.com/m5n/nutriana to avoid foreign key error', '0', 'g', '', '0');
