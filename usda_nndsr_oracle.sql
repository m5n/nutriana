-- =========================================================================================================
-- USDA National Nutrient Database for Standard Reference, Release 25 (http://www.ars.usda.gov/nutrientdata)
...
-- Assert all 525 records were loaded
CREATE TABLE tmp (c NUMBER PRIMARY KEY);
INSERT INTO tmp (c) VALUES (2);
INSERT INTO tmp (SELECT COUNT(*) FROM FOOTNOTE);
DELETE FROM tmp WHERE c = 525;
INSERT INTO tmp (SELECT COUNT(*) FROM tmp);
DROP TABLE tmp;
...
-- Assert all 39085 records were loaded
CREATE TABLE tmp (c NUMBER PRIMARY KEY);
INSERT INTO tmp (c) VALUES (2);
INSERT INTO tmp (SELECT COUNT(*) FROM LANGUAL);
DELETE FROM tmp WHERE c = 39085;
INSERT INTO tmp (SELECT COUNT(*) FROM tmp);
DROP TABLE tmp;
