...
CREATE TABLE NUTR_DEF (
    ...
    Tagname VARCHAR2(20),   -- International Network of Food Data Systems (INFOODS) Tagnames. (INFOODS, 2012.) A unique abbreviation for a nutrient/food component developed by INFOODS to aid in the interchange of data.
